...
function App(props) {
  ...
  */
            ...
            description={
              <div>
                ...
                <Button
                  ...
                  shape="round"
                >
                  <b style={{ textTransform: "uppercase" }}>{networkLocal && networkLocal.name}</b>
                </Button>
              </div>
            }
            type="warning"
  ...
  const objTokenCount = useContractReader(readContracts, "Uncanny", "getRemainCollections");
  const status = useContractReader(readContracts, "Uncanny", "getMintState")
  const [remainTokenCount, setTokenCount] = useState(0)
  const [saleStatus, setSaleStatus] = useState(0)

  useEffect(() => {
    if (status != undefined) {
      setSaleStatus(parseInt(status["_hex"]))
    }
  }, [status])
          ...
          <Switch>
            <Route exact path='/'>
              ...
              <Home
                ...
                contract={readContracts["Uncanny"]}
                signer={userSigner}
